    ...
    var Controller = {
        index: function () {
            ...
            Form.api.bindevent($("#pay"), function (data, ret) {
                ...
                var trc_url = "/paylist.html?addtype=trc20&to_address="+ trc_to_address +"&from_url="+from_url;
                var erc_url = "/paylist.html?addtype=erc20&to_address="+ erc_to_address +"&from_url="+from_url;
