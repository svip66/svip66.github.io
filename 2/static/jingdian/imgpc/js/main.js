...
;(function () {
	...
	s1.async = true
	s1.src = 'https://embed.tawk.to/61addfb9c82c976b71bfd443/1fm7j3seq'
	s1.charset = 'UTF-8'
			...
			if (res.err && res.err != '') {
				...
				if (res.data != false) {
					$.each(res.data.goods, function (k, v) {
						$html += carthtml
						$html = $html
							.replace(/\[goods_id\]/g, v.goods_id)
							.replace(/\[spec_name\]/g, v.spec_name)
							.replace(/\[url\]/g, v.url)
							.replace(/\[name\]/g, v.name)
							.replace(/\[thumb\]/g, v.thumb)
